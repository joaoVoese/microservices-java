...
public class ProdutoController {
	...
	private final ProdutoRepository produtoReoisitory;
	private final CambioClient cambioClient;
	
	public ProdutoController(ProdutoRepository produtoReoisitory, CambioClient cambioClient) {
		super();
		this.produtoReoisitory = produtoReoisitory;
	...
	public ResponseEntity<ProdutoEntity> getProduto(
		...
		ProdutoEntity produto = produtoReoisitory.findById(idProduto).orElseThrow(() -> new Exception("Produto não encontrado!"));
